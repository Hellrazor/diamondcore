...
struct DIAMOND_DLL_DECL npc_astor_hadrenAI : public ScriptedAI
{
...
struct DIAMOND_DLL_DECL npc_deathstalker_erlandAI : public npc_escortAI
{
...
struct DIAMOND_DLL_DECL npc_deathstalker_faerleiaAI : public ScriptedAI
{
