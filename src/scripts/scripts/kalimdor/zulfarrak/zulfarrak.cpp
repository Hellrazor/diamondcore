...
struct DIAMOND_DLL_DECL npc_sergeant_blyAI : public ScriptedAI
{
    ...
    uint32 Revenge_Timer;                                   //this is wrong, spell should never be used unless m_creature->getVictim() dodge, parry or block attack. DiamondCore support required.
...
struct DIAMOND_DLL_DECL npc_weegli_blastfuseAI : public ScriptedAI
{
