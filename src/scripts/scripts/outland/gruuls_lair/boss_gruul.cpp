...
SDName: Boss_Gruul
SD%Complete: 60
SDComment: Ground Slam need further development (knock back effect and shatter effect must be added to DiamondCore)
...
struct DIAMOND_DLL_DECL boss_gruulAI : public ScriptedAI
{
    ...
    void SpellHitTarget(Unit* pTarget, const SpellEntry* pSpell)
    {
        ...
        //this part should be in DiamondCore
        if (pSpell->Id == SPELL_SHATTER)
        {
            //this spell must have custom handling in DiamondCore, dealing damage based on distance
