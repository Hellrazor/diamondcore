...
// TODO: clean up this workaround when DiamondCore adds support to do it properly (with gossip selections instead of instant summon)
...
struct DIAMOND_DLL_DECL npc_commander_dawnforgeAI : public ScriptedAI
{
    ...
    bool CanStartEvent(Player* pPlayer)
    {
        ...
        debug_log("DS: npc_commander_dawnforge event already in progress, need to wait.");
        return false;
    }
