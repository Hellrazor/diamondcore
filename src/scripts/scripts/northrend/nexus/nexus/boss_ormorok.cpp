...
SDName: Boss_Ormorok
SD%Complete: 50%
SDComment: TODO: Correct timers. Research how spikes work, and attempt code it properly from DiamondCore side.
SDCategory: Nexus
EndScriptData */
...
struct DIAMOND_DLL_DECL boss_ormorokAI : public ScriptedAI
{
