...
//                                      = 783, not used
    ...
    LANG_COMMAND_TICKETCLOSED           = 1303,
    LANG_COMMAND_TICKETDELETED          = 1304,
    LANG_COMMAND_TICKETNOTEXIST         = 1305,
    LANG_COMMAND_TICKETCLOSEFIRST       = 1306,
    LANG_COMMAND_TICKETALREADYASSIGNED  = 1307,
    LANG_COMMAND_TICKETRELOAD           = 1308,
    LANG_COMMAND_TICKETSHOWLIST         = 1309,
    LANG_COMMAND_TICKETSHOWONLINELIST   = 1310,
    LANG_COMMAND_TICKETSHOWCLOSEDLIST   = 1311,
    LANG_COMMAND_TICKETASSIGNERROR_A    = 1312,
    LANG_COMMAND_TICKETASSIGNERROR_B    = 1313,
    LANG_COMMAND_TICKETNOTASSIGNED      = 1314,
    LANG_COMMAND_TICKETUNASSIGNSECURITY = 1315,
    LANG_COMMAND_TICKETCANNOTCLOSE      = 1316,
    LANG_COMMAND_TICKETLISTGUID         = 1317,
    LANG_COMMAND_TICKETLISTNAME         = 1318,
    LANG_COMMAND_TICKETLISTAGE          = 1319,
    LANG_COMMAND_TICKETLISTASSIGNEDTO   = 1320,
    LANG_COMMAND_TICKETLISTUNASSIGNED   = 1321,
    LANG_COMMAND_TICKETLISTMESSAGE      = 1322,
    LANG_COMMAND_TICKETLISTCOMMENT      = 1323,
