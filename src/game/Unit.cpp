...
Unit* Unit::SelectRandomUnfriendlyTarget(Unit* except /*= NULL*/, float radius /*= ATTACK_DISTANCE*/) const
{
    ...
    Diamond::AnyUnfriendlyUnitInObjectRangeCheck u_check(this, this, radius);
...
Unit* Unit::SelectRandomFriendlyTarget(Unit* except /*= NULL*/, float radius /*= ATTACK_DISTANCE*/) const
{
    ...
    Diamond::AnyFriendlyUnitInObjectRangeCheck u_check(this, radius);
    Diamond::UnitListSearcher<Diamond::AnyFriendlyUnitInObjectRangeCheck> searcher(this, targets, u_check);
