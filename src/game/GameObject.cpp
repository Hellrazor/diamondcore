        ...
        case GO_READY:
        {
            ...
            if(isSpawned())
            {
                ...
                if(goInfo->type == GAMEOBJECT_TYPE_TRAP)
                {
                    ...
                    {
                        Diamond::AnyUnfriendlyUnitInObjectRangeCheck u_check(this, owner, radius);
                        Diamond::UnitSearcher<Diamond::AnyUnfriendlyUnitInObjectRangeCheck> checker(this,ok, u_check);
                    ...
                    else                                        // environmental trap
                    {
                        ...
                        // affect only players
                        Player* p_ok = NULL;
                        Diamond::AnyPlayerInObjectRangeCheck p_check(this, radius);
                        Diamond::PlayerSearcher<Diamond::AnyPlayerInObjectRangeCheck>  checker(this,p_ok, p_check);
                        Cell::VisitWorldObjects(this,checker, radius);
                        ok = p_ok;
                    }
...
void GameObject::SaveToDB(uint32 mapid, uint8 spawnMask, uint32 phaseMask)
{
    ...
    WorldDatabase.PExecuteLog("DELETE FROM gameobject_spawns WHERE guid = '%u'", m_DBTableGuid);
