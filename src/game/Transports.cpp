...
void MapManager::LoadTransports()
{
    ...
    result = WorldDatabase.Query("SELECT gameobject_spawns.guid,gameobject_spawns.id,transports.name FROM gameobject_spawns,transports WHERE gameobject_spawns.id = transports.entry");
