...
class ObjectMgr
{
    ...
    public:
        ...
        bool LoadStrings(DatabaseType& db, char const* table, int32 min_value, int32 max_value);
        bool LoadStrings() { return LoadStrings(WorldDatabase,"strings",MIN_DIAMOND_STRING_ID,MAX_DIAMOND_STRING_ID); }
