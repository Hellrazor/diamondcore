...
#ifndef DIAMOND_OBJECTREGISTRY_H
#define DIAMOND_OBJECTREGISTRY_H
...
class DIAMOND_DLL_DECL ObjectRegistry
{
    public:
    ...
    private:
        ...
        friend class Diamond::OperatorNew<ObjectRegistry<T, Key> >;
