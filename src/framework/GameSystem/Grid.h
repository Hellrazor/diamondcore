...
#ifndef DIAMOND_GRID_H
#define DIAMOND_GRID_H

/*
  @class Grid
  Grid is a logical segment of the game world represented inside DiamondCore.
...
class ThreadModel = Diamond::SingleThreaded<ACTIVE_OBJECT>
>
class DIAMOND_DLL_DECL Grid
{
